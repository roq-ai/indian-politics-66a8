...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'politician.update': {
    roles: ['administrator', 'profile-manager'],
    key: 'politician-profile-update',
    tenantPath: ['organization', 'user', 'politician'],
    userPath: [],
  },
  'profile_usage.update': {
    roles: ['data-analyst'],
    key: 'profile-usage-update',
    tenantPath: ['organization', 'user', 'politician', 'profile_usage'],
    userPath: [],
  },
  'politician.delete': {
    roles: ['administrator'],
    key: 'politician-profile-deletion',
    tenantPath: ['organization', 'user', 'politician'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'politician', 'data-analyst', 'profile-manager'];
