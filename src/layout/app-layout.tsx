...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'politician', 'data-analyst', 'profile-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Guests', path: '/guests', entity: 'guest', service: AccessServiceEnum.PROJECT, icon: FiEye },
    {
