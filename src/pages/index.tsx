...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Indian Politics`}</title>

        <meta
          name="description"
          content="Empowering Leaders with Indian Politics: Streamline Your Profile, Share Your Journey, and Evaluate Your Impact. A Centralized Platform for Politicians and Administrators."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1555848962-6e79363ec58f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxJbmRpYW4lMjBwb2xpdGljc3xlbnwwfHx8fDE2OTQwMTQ2NjR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@adijoshi11?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Aditya Joshi`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Leaders with Indian Politics: Streamline Your Profile, Share Your Journey, and Evaluate Your Impact. A Centralized Platform for Politicians and Administrators.`}
            </Text>
            <Box
