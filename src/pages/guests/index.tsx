...
export function GuestListPage(props: GuestListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getGuests({
        ...
        order: params.order,
        searchTermKeys: ['search_history.contains', 'viewed_profiles.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'search_history', header: 'Search History', accessorKey: 'search_history' },
    { id: 'viewed_profiles', header: 'Viewed Profiles', accessorKey: 'viewed_profiles' },
