    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <TextInput
            error={formik.errors.search_history}
            label={'Search History'}
            props={{
              name: 'search_history',
              placeholder: 'Search History',
              value: formik.values?.search_history,
              onChange: formik.handleChange,
            }}
          />

          <TextInput
            error={formik.errors.viewed_profiles}
            label={'Viewed Profiles'}
            props={{
              name: 'viewed_profiles',
              placeholder: 'Viewed Profiles',
              value: formik.values?.viewed_profiles,
              onChange: formik.handleChange,
            }}
          />
